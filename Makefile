...
help:
	...
	@printf "  make package-windows-x64 version=x.y.z  Build unsigned Windows x64 portable EXE\n"
	@printf "  make package-windows-arm64 version=x.y.z  Build unsigned Windows arm64 portable EXE\n"
	@printf "  make package-linux-x64 version=x.y.z  Build unsigned Linux x64 AppImage\n"
	@printf "  make package-linux-arm64 version=x.y.z  Build unsigned Linux arm64 AppImage\n"
